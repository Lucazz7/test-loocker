...
function useKeyDown() {
  ...
  function checkOnChange() {
    if (onChange) {
      if (context.transition) {
        ...
        var newOptions = (0, _xorWith.default)(data.options, navigationOption ? [navigationOption] : [], (o1, o2) => o1.value === o2.value);
        onChange(newOptions);
      }
    }
  }
  ...
  return (0, _throttle.default)(function handleKeyDown(event) {
    ...
    switch (event.key) {
      ...
      case 'Spacebar':
        {
          if (readOnlyPropRef && readOnlyPropRef.current && state === _state.ComboboxState.NAVIGATING && navigationOption !== undefined) {
            selectOption();
          }
