...
var ButtonGroupLayout = (0, _react.forwardRef)((_ref, ref) => {
  var {
    onChange,
    value = []
  } = _ref,
      props = _objectWithoutProperties(_ref, ["onChange", "value"]);
...
var ButtonGroup = (0, _styledComponents.default)(ButtonGroupLayout).withConfig({
...
})(["", "{border:1px solid ", ";border-radius:", ";margin-right:", ";&:last-child{margin-right:0;}&[aria-pressed='false']:not(:hover){background:", ";}&[aria-pressed='true']{border-color:", ";}}&.wrapping{margin:-", ";", "{margin:", ";}}"], _ButtonItem.ButtonItem, (_ref2) => {
  var {
    theme
  } = _ref2;
  ...
  return theme.space.xxxsmall;
}, _ButtonItem.ButtonItem, (_ref8) => {
  var {
    theme
  } = _ref8;
  return theme.space.xxxsmall;
