...
var _stateful = require("../../utils/color/stateful");
...
var fallbackStateful = {
  keySubtle: _palette.purple000,
  keyAccent: _palette.purple100,
  keyFocus: _palette.purple300,
  keyInteractive: (0, _stateful.generateInteractive)(_palette.purple400),
  keyPressed: (0, _stateful.generatePressed)(_palette.purple400),
  ...
  criticalInteractive: (0, _stateful.generateInteractive)(_palette.red500),
  criticalPressed: (0, _stateful.generatePressed)(_palette.red500),
  ...
  neutralInteractive: (0, _stateful.generateInteractive)(_palette.charcoal500),
  neutralPressed: (0, _stateful.generatePressed)(_palette.charcoal500),
