...
class NodeSession extends _authSession.AuthSession {
  constructor(settings, transport) {
    ...
    _defineProperty(this, "_authToken", new _authToken.AuthToken());

    _defineProperty(this, "_sudoToken", new _authToken.AuthToken());

    this.apiPath = "/api/".concat(_constants.defaultApiVersion);
  }
  ...
  _login(newId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (!_this6._authToken.isActive()) {
        ...
        var clientId = (0, _nodeSettings.getenv)(_apiSettings.strLookerClientId, section.client_id);
        var clientSecret = (0, _nodeSettings.getenv)(_apiSettings.strLookerClientSecret, section.client_secret);
        ...
        var body = (0, _transport.encodeParams)({
          client_id: clientId,
