...
export declare class Looker31SDK extends APIMethods {
    ...
    search_folders(request: IRequestSearchSpaces, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IFolder[], IError>>;
    ...
    search_spaces(request: IRequestSearchSpaces, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISpace[], IError>>;
