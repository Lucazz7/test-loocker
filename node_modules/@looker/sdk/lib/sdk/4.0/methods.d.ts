...
import { IDictionary, IAccessToken, IApiSession, IApiVersion, IBackupConfiguration, IBoard, IBoardItem, IBoardSection, IColorCollection, ICommand, IContentFavorite, IContentMeta, IContentMetaGroupUser, IContentValidation, IContentView, ICreateFolder, ICredentialsApi3, ICredentialsEmail, ICredentialsEmbed, ICredentialsGoogle, ICredentialsLDAP, ICredentialsLookerOpenid, ICredentialsOIDC, ICredentialsSaml, ICredentialsTotp, ICustomWelcomeEmail, IDashboard, IDashboardAggregateTableLookml, IDashboardBase, IDashboardElement, IDashboardFilter, IDashboardLayout, IDashboardLayoutComponent, IDashboardLookml, IDataActionForm, IDataActionRequest, IDataActionResponse, IDatagroup, IDBConnection, IDBConnectionTestResult, IDialectInfo, IDigestEmails, IDigestEmailSend, IEmbedParams, IEmbedSsoParams, IEmbedUrlResponse, IError, IFolder, IGitBranch, IGitConnectionTest, IGitConnectionTestResult, IGroup, IGroupIdForGroupInclusion, IGroupIdForGroupUserInclusion, IGroupSearch, IHomepageSection, IIntegration, IIntegrationHub, IIntegrationTestResult, IInternalHelpResources, IInternalHelpResourcesContent, ILDAPConfig, ILDAPConfigTestResult, ILegacyFeature, ILocale, ILook, ILookmlModel, ILookmlModelExplore, ILookmlTest, ILookmlTestResult, ILookWithQuery, IManifest, IMergeQuery, IModelSet, IOauthClientApp, IOIDCConfig, IPasswordConfig, IPermission, IPermissionSet, IProject, IProjectFile, IProjectValidation, IProjectValidationCache, IProjectWorkspace, IQuery, IQueryTask, IRenderTask, IRepositoryCredential, IRequestActiveThemes, IRequestAllBoardItems, IRequestAllBoardSections, IRequestAllGroups, IRequestAllGroupUsers, IRequestAllIntegrations, IRequestAllRoles, IRequestAllScheduledPlans, IRequestAllUsers, IRequestContentThumbnail, IRequestCreateDashboardRenderTask, IRequestCreateQueryTask, IRequestCreateUserCredentialsEmailPasswordReset, IRequestDeployRefToProduction, IRequestFolderChildren, IRequestFolderChildrenSearch, IRequestGetAllCommands, IRequestLogin, IRequestRoleUsers, IRequestRunInlineQuery, IRequestRunLook, IRequestRunLookmlTest, IRequestRunQuery, IRequestScheduledPlansForDashboard, IRequestScheduledPlansForLook, IRequestScheduledPlansForLookmlDashboard, IRequestSearchBoards, IRequestSearchContentFavorites, IRequestSearchContentViews, IRequestSearchDashboardElements, IRequestSearchDashboards, IRequestSearchFolders, IRequestSearchGroups, IRequestSearchLooks, IRequestSearchModelSets, IRequestSearchRoles, IRequestSearchThemes, IRequestSearchUserLoginLockouts, IRequestSearchUsers, IRequestSearchUsersNames, IRequestUserAttributeUserValues, IRequestUserRoles, IRole, IRunningQueries, ISamlConfig, ISamlMetadataParseResult, IScheduledPlan, ISession, ISessionConfig, ISqlQuery, ISqlQueryCreate, ISshPublicKey, ISshServer, ISshTunnel, ITheme, ITimezone, IUpdateCommand, IUpdateFolder, IUser, IUserAttribute, IUserAttributeGroupValue, IUserAttributeWithValue, IUserLoginLockout, IValidationError, IWelcomeEmailTest, IWhitelabelConfiguration, IWorkspace, IWriteApiSession, IWriteBackupConfiguration, IWriteBoard, IWriteBoardItem, IWriteBoardSection, IWriteColorCollection, IWriteCommand, IWriteContentFavorite, IWriteContentMeta, IWriteCreateDashboardFilter, IWriteCredentialsEmail, IWriteCustomWelcomeEmail, IWriteDashboard, IWriteDashboardElement, IWriteDashboardFilter, IWriteDashboardLayout, IWriteDashboardLayoutComponent, IWriteDatagroup, IWriteDBConnection, IWriteGitBranch, IWriteGroup, IWriteIntegration, IWriteIntegrationHub, IWriteInternalHelpResources, IWriteInternalHelpResourcesContent, IWriteLDAPConfig, IWriteLegacyFeature, IWriteLookmlModel, IWriteLookWithQuery, IWriteMergeQuery, IWriteModelSet, IWriteOauthClientApp, IWriteOIDCConfig, IWritePasswordConfig, IWritePermissionSet, IWriteProject, IWriteQuery, IWriteRepositoryCredential, IWriteRole, IWriteSamlConfig, IWriteScheduledPlan, IWriteSessionConfig, IWriteSshServer, IWriteSshTunnel, IWriteTheme, IWriteUser, IWriteUserAttribute, IWriteUserAttributeWithValue, IWriteWhitelabelConfiguration } from './models';
export declare class Looker40SDK extends APIMethods {
    ...
    all_oauth_client_apps(fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IOauthClientApp[], IError>>;
    oauth_client_app(client_guid: string, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IOauthClientApp, IError>>;
    register_oauth_client_app(client_guid: string, body: Partial<IWriteOauthClientApp>, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IOauthClientApp, IValidationError | IError>>;
    update_oauth_client_app(client_guid: string, body: Partial<IWriteOauthClientApp>, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IOauthClientApp, IValidationError | IError>>;
    delete_oauth_client_app(client_guid: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    invalidate_tokens(client_guid: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    activate_app_user(client_guid: string, user_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IValidationError | IError>>;
    deactivate_app_user(client_guid: string, user_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    ...
    get_all_commands(request: IRequestGetAllCommands, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ICommand[], IError>>;
    create_command(body: Partial<IWriteCommand>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ICommand, IValidationError | IError>>;
    update_command(command_id: number, body: Partial<IUpdateCommand>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ICommand, IValidationError | IError>>;
    delete_command(command_id: number, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<void, IError>>;
    ...
    test_connection(connection_name: string, tests?: DelimArray<string>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IDBConnectionTestResult[], IValidationError | IError>>;
    ...
    all_ssh_servers(fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshServer[], IError>>;
    create_ssh_server(body: Partial<IWriteSshServer>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshServer, IValidationError | IError>>;
    ssh_server(ssh_server_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshServer, IError>>;
    update_ssh_server(ssh_server_id: string, body: Partial<IWriteSshServer>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshServer, IValidationError | IError>>;
    delete_ssh_server(ssh_server_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    test_ssh_server(ssh_server_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshServer, IError>>;
    all_ssh_tunnels(fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshTunnel[], IError>>;
    create_ssh_tunnel(body: Partial<IWriteSshTunnel>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshTunnel, IValidationError | IError>>;
    ssh_tunnel(ssh_tunnel_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshTunnel, IError>>;
    update_ssh_tunnel(ssh_tunnel_id: string, body: Partial<IWriteSshTunnel>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshTunnel, IValidationError | IError>>;
    delete_ssh_tunnel(ssh_tunnel_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    test_ssh_tunnel(ssh_tunnel_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshTunnel, IError>>;
    ssh_public_key(options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISshPublicKey, IError>>;
    ...
    content_thumbnail(request: IRequestContentThumbnail, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    ...
    dashboard_aggregate_table_lookml(dashboard_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IDashboardAggregateTableLookml, IError>>;
    ...
    search_groups_with_roles(request: IRequestSearchGroups, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IGroupSearch[], IError>>;
    ...
    all_primary_homepage_sections(fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepageSection[], IError>>;
    ...
    fetch_integration_form(integration_id: string, body?: Partial<IDictionary<string>>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IDataActionForm, IValidationError | IError>>;
    ...
    lock_all(project_id: string, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IValidationError | IError>>;
    ...
    deploy_ref_to_production(request: IRequestDeployRefToProduction, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IValidationError | IError>>;
    deploy_to_production(project_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IValidationError | IError>>;
    reset_project_to_production(project_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IValidationError | IError>>;
    reset_project_to_remote(project_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IValidationError | IError>>;
    ...
    create_git_deploy_key(project_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IValidationError | IError>>;
    ...
    create_sql_query(body: Partial<ISqlQueryCreate>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISqlQuery, IValidationError | IError>>;
    ...
    scheduled_plan_run_once(body: Partial<IWriteScheduledPlan>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IScheduledPlan, IValidationError | IError>>;
    ...
    send_user_credentials_email_password_reset(user_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ICredentialsEmail, IError>>;
