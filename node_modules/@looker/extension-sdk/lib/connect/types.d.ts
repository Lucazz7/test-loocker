...
export interface ExtensionSDK {
     ...
     * serverProxy with some specialized processing for oauth2 code for
     * access token exchange. It is expected that this method is called
     * immediately after oauth2Authenticate. The state and redirect url
